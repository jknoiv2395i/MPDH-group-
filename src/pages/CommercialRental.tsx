    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[689px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="font-instrument text-[100px] md:text-[150px] lg:text-[180px] font-normal leading-tight text-white tracking-[-4.281px]">
            Commercial Properties
          </h1>
          <div className="mt-6">
            <h2 className="font-instrument text-[32px] md:text-[40px] font-normal leading-tight text-black tracking-[-1.224px]">
              Urban retreat
            </h2>
            <p className="text-[#5D5D5D] font-inter text-lg leading-relaxed tracking-[0.363px] mt-4 max-w-md mx-auto">
