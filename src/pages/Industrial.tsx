...
const Industrial = () => {
  ...
  const properties = getByCategory('industrial').map(p => ({
    ...
    image: p.images[0] || 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=1200&q=80',
    images: p.images.length > 0 ? p.images : ['https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=1200&q=80'],
    price: p.price,
  }));
