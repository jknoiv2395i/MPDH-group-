    ...
    <section className="bg-white py-20 lg:py-32">
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
        <div className="mb-12 lg:mb-16">
          <h2 className="font-instrument text-4xl lg:text-5xl xl:text-6xl font-normal text-black mb-8 lg:mb-12 tracking-tight">
            OUR SERVICES
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12 lg:mb-16">
          {services.map((service, index) => (
            <div key={index} className="border border-[#C3D5F1] rounded-2xl p-6 lg:p-8 h-full flex flex-col">
              <div className="w-16 h-16 bg-[#071839] rounded-full flex items-center justify-center mb-6 lg:mb-8">
                {service.icon}
              </div>
              
              <h3 className="font-instrument text-xl lg:text-2xl xl:text-3xl font-normal text-[#131313] mb-6 lg:mb-8 leading-tight">
                {service.title}
              </h3>
              
              <div className="flex-grow">
                <p className="text-[#5D5D5D] text-base lg:text-lg leading-relaxed mb-6 lg:mb-8">
                  {service.description}
                </p>
              </div>
              
              <div className="flex items-center gap-3 text-[#131313] text-base lg:text-lg">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
          <p className="text-[#5D5D5D] text-base lg:text-lg leading-relaxed max-w-xl">
          ...
          <button className="bg-[#131313] text-white px-8 py-4 rounded-full text-base lg:text-lg font-medium hover:bg-gray-800 transition-colors self-start lg:self-auto">
            View all
          </button>
        </div>
      </div>
