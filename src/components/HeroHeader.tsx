...
const HeroHeader = () => {
  return <header className="flex items-center justify-between w-full px-6 md:px-12 lg:px-16 py-6">
      {/* Logo */}
      <div className="flex items-center space-x-2">
        <div className="w-182 h-182 bg-hero-foreground rounded-sm flex items-center justify-center">
