      ...
      <div className="relative bg-transparent w-full max-w-2xl">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 w-full">
          ...
          <div className="flex-1 relative">
            {/* Header */}
            <div className="mb-6">
              <h2 className="text-white text-2xl font-normal font-inter leading-7 tracking-[0.363px]">
                Want to Purchase?
              </h2>
            </div>
            ...
            <button
              ...
              className="relative w-full bg-white rounded-full h-14 flex items-center px-6 hover:bg-gray-50 transition-colors group"
            >
              ...
              <div className="absolute right-1 w-11 h-11 bg-[#131313] rounded-full flex items-center justify-center group-hover:bg-gray-800 transition-colors">
                ...
                >
                  <path 
                    d="M6.50034 5.29883H13.7115V12.51M13.2108 5.79961L5.89941 13.111" 
                    stroke="white" 
                    strokeWidth="1.69969" 
                    strokeMiterlimit="10" 
