...
import { cn, isBuilderEditor } from "@/lib/utils"
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <ToastPrimitives.Viewport
      ...
      className={cn(
        isEditor
          ? "fixed top-0 z-10 pointer-events-none flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]"
