const HeroContent = () => {
  return <div className="flex-1 flex items-center justify-center px-4 sm:px-6 md:px-12 lg:px-16 relative min-h-screen sm:min-h-[800px] lg:min-h-[1272px]" style={{
